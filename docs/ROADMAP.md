...
| 2 | COBOL Reader (single file → structured JSON) | **V1_REPORTED_PASS / V2_PENDING** (2026-09-06) | [Evidence](gate-2-evidence.md) |
| 3 | Legacy Analyzer (full system → assessment) | NOT_RUN | Gate 2 (blocked pending Gate 2 V2 validation) |
