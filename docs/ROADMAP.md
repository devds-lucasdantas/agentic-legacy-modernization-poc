...
| 2 | COBOL Reader (single file → structured JSON) | **PASS** (2026-09-11) | [Evidence](gate-2-evidence.md) |
| 3 | Legacy Analyzer (full system → assessment) | IN_PROGRESS | Gate 2 | [Spec](gate-3-spec.md) |
